<template>
   <v-form @submit.prevent="save" ref="form" v-model="valid" lazy-validation>
    ...
    <v-btn type="submit" block color="primary" :loading="isLoading" @click="save">회원정보수정</v-btn>
  </v-form>
</template>
...
export default {
  components: { InputDuplicateCheck, InputPassword,  InputDate, InputRadio, InputPhone, InputPost, DisplayAvatar},
  name: "SignUpForm",
  props : {
    admMode : {
      type : Boolean,
